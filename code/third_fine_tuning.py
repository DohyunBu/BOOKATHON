...
model = AutoModelWithLMHead.from_pretrained("./fine_tuning3/first_model/")

path = [str(x) for x in Path("./5전처리_데이터3/").glob("*.txt")]
...
learn.model.save_pretrained("./5fine_tuning4/first_model/")